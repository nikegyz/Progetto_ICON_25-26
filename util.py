...
def delete_files():
    # Elimina silenziosamente i file temporanei creati dal processo di classificazione.
    # Questi file servono solo durante l'esecuzione (per popolare la Knowledge Base nei test)
    # e vengono rimossi al termine.
    for temp_file in ('./classification_file_patient.txt', './classification_statements.txt'):
